 ...
 */
package com.ubc.common.samplerender;
...
public class SampleRender {
    ...
    glSurfaceView.setRenderer(
        new GLSurfaceView.Renderer() {
          ...
          public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            com.ubc.common.samplerender.GLError.maybeThrowGLException("Failed to enable blending", "glEnable");
  ...
  public void draw(com.ubc.common.samplerender.Mesh mesh, Shader shader) {
   ...
   */
  public void draw(com.ubc.common.samplerender.Mesh mesh, Shader shader, com.ubc.common.samplerender.Framebuffer framebuffer) {
   ...
   * cleared.
   */
  public void clear(com.ubc.common.samplerender.Framebuffer framebuffer, float r, float g, float b, float a) {
    useFramebuffer(framebuffer);
    GLES30.glClearColor(r, g, b, a);
    com.ubc.common.samplerender.GLError.maybeThrowGLException("Failed to set clear color", "glClearColor");
    GLES30.glDepthMask(true);
    com.ubc.common.samplerender.GLError.maybeThrowGLException("Failed to set depth write mask", "glDepthMask");
    GLES30.glClear(GLES30.GL_COLOR_BUFFER_BIT | GLES30.GL_DEPTH_BUFFER_BIT);
    com.ubc.common.samplerender.GLError.maybeThrowGLException("Failed to clear framebuffer", "glClear");
  }
  ...
  private void useFramebuffer(com.ubc.common.samplerender.Framebuffer framebuffer) {
    int framebufferId;
    int viewportWidth;
    int viewportHeight;
    if (framebuffer == null) {
    ...
    com.ubc.common.samplerender.GLError.maybeThrowGLException("Failed to bind framebuffer", "glBindFramebuffer");
    GLES30.glViewport(0, 0, viewportWidth, viewportHeight);
    com.ubc.common.samplerender.GLError.maybeThrowGLException("Failed to set viewport dimensions", "glViewport");
  }
}
