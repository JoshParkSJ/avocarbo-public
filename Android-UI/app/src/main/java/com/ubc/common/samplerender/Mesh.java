...
public class Mesh implements Closeable {
  ...
  public Mesh(
    ...
    try {
      ...
      com.ubc.common.samplerender.GLError.maybeThrowGLException("Failed to generate a vertex array", "glGenVertexArrays");

      // Bind vertex array
      GLES30.glBindVertexArray(vertexArrayId[0]);
      com.ubc.common.samplerender.GLError.maybeThrowGLException("Failed to bind vertex array object", "glBindVertexArray");
      ...
      for (int i = 0; i < vertexBuffers.length; ++i) {
        ...
        com.ubc.common.samplerender.GLError.maybeThrowGLException("Failed to bind vertex buffer", "glBindBuffer");
        GLES30.glVertexAttribPointer(
            i, vertexBuffers[i].getNumberOfEntriesPerVertex(), GLES30.GL_FLOAT, false, 0, 0);
        com.ubc.common.samplerender.GLError.maybeThrowGLException(
  ...
  public void lowLevelDraw() {
    ...
    if (indexBuffer == null) {
      ...
      com.ubc.common.samplerender.GLError.maybeThrowGLException("Failed to draw vertex array object", "glDrawArrays");
    } else {
